...
extra_kernel_params = console=ttyS0 ipa-inspector-collectors=default,extra-hardware,logs ipa-enable-vlan-interfaces=${IRONIC_INSPECTOR_VLAN_INTERFACES} ipa-inspection-dhcp-all-interfaces=1 ipa-collect-lldp=1 ${INSPECTOR_EXTRA_ARGS}
